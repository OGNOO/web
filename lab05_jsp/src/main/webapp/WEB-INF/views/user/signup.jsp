		...
		<main>
			<div class="card mt-2">
				<div class="card-header text-center text-white bg-dark bg-gradient"
					...
					<h2 style="margin-top: 0.25em; letter-spacing: 0.3em">계정 만들기</h2>
				</div>
					...
					<form method="post" action="${ signup }">
						...
						<div class="ms-5 me-5 mt-3">
							<input class="form-control" name="email" type="email"
								placeholder="이메일 주소를 입력해 주세요" required />
						</div>
						<div class="ms-5 me-5 mt-3">
						...
						<div class="ms-5 me-5 mt-3">
							<input id="checkPw" class="form-control" name="password"
								type="password" placeholder="비밀번호를 재입력해 주세요" required />
						</div>
						<div id="wrongPw" class="ms-5 me-5 mt-1" style="display: none">
							<p class="mb-0" style="color: red">비밀번호가 일치하지 않습니다.</p>
						</div>
