            ...
            <div class="row">
              ...
              <div class="col-7">
                <input type="text" class="form-control" name="keyword"
                  placeholder="검색어 입력" required autofocus />
              </div>
              <div class="col-2">
                <input id="formSubmit" type="submit"
                  class="form-control btn btn-secondary" value="검색" />
              </div>
            </div>
          </form>
        </div>
        <div class="card-body" style="padding: 0; overflow-x: auto">
          <table class="table table-hover table-dark table-striped">
            <thead style="text-align: center">
              <tr>
                <td style="width: 10%"><button id="no"
                    class="btn btn-outline-light btn-sm"
                    style="width: 100%;">NO</button></td>
                <td style="width: 33%"><button
                    class="btn btn-outline-light btn-sm"
                    style="width: 70%;">Title</button></td>
                <td style="width: 33%"><button
                    class="btn btn-outline-light btn-sm"
                    style="width: 80%;">Author</button></td>
                <td><button class="btn btn-outline-light btn-sm"
                    style="width: 70%;">M.T</button></td>
              </tr>
            </thead>
            <tbody>
              <c:forEach items="${ posts }" var="p">
                <tr>
                  ...
                  <td style="white-space: nowrap; overflow: hidden">
                    ${ p.author }</td>
                  <td class="modifiedTime"
                    style="text-align: end; white-space: nowrap; overflow: hidden;">
                    ${ p.modifiedTime }</td>
                </tr>
              </c:forEach>
            </tbody>
