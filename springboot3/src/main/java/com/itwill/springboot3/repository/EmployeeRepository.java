...
public interface EmployeeRepository extends JpaRepository<Employee, Integer> {
	...
	@Query("SELECT e FROM Employee e where e.department.location.city = :cityName")
	List<Employee> findByDeptCityName(@Param("cityName") String cityName);

	@Query("SELECT e FROM Employee e where e.department.location.country.countryName = :countryName")
	List<Employee> findByDeptCountryName(@Param("countryName") String countryName);
